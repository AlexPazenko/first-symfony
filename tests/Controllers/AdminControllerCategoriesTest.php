...
/*    public function tearDown(): void
    ...
    {
        $crawler = $this->client->request('GET', '/my-profile/categories');
    ...
    {
        $crawler = $this->client->request('GET', '/my-profile/edit-categories/1');
    ...
    {
        $crawler = $this->client->request('GET', '/my-profile/delete-category/1');
